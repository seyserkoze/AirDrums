...
class Audio:
    ...
    def play_sound(self, drum: str, volume: int) -> None:
        ...
        file_name: str = os.path.join(directory, self.drum_to_file[drum])
    ...
    def __worker(self) -> None:
        ...
        """
        while True:
            (args): (str, int) = self.task_queue.get()
            drum: str = args[0]
            volume: int = args[1]
    ...
    def __test(self) -> None:
        ...
        :return: None
        """
        self.task_queue.put(('clap', 100))
        self.task_queue.put(('cowbell', 100))
        self.task_queue.put(('openhat', 100))
        self.task_queue.put(('ride', 100))
        self.task_queue.put(('crash', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('crash', 100))
        self.task_queue.put(('hihat', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('tambo', 100))
        self.task_queue.put(('tambo', 100))
        self.task_queue.put(('tambo', 100))
        self.task_queue.put(('tambo', 100))
        self.task_queue.put(('tom', 100))
        self.task_queue.put(('tom', 100))
        self.task_queue.put(('tom', 100))
        self.task_queue.put(('kick', 100))
        self.task_queue.put(('kick', 100))
    ...
    def __init__(self) -> None:
        ...
        self.drum_to_file: Dict[str, str] = {
